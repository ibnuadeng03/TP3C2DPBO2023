...
session_start(); 
$_SESSION['base_url'] = 'http://localhost/rsud_majalaya/';
...
<body class="py-0">
    <div class="container mt-5">
        <div class="col-md-4 mx-auto text-center">
			<img src="img/logo.png" alt="Logo RSUD Majalaya" class="Logo-png">
			<br>
			<br>
            <h3> ~ AMANDA ~ </h3>
			<h5> Aplikasi Mandiri Daftar Antrean </h5>
			<h7> Jl. Cipaku No.87, Cipaku, Kec. Paseh, Kabupaten Bandung, Jawa Barat 40383</h7>
			<br>
			<br>
			<h5> Silakan Log In</h5>
